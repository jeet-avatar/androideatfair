...
data class ExtendedColorScheme(
    val customColor1: ExtendedColorFamily,
)
...
val extendedLight = ExtendedColorScheme(
    customColor1 = ExtendedColorFamily(
        customColor1Light,
        onCustomColor1Light,
...
val unspecified_scheme = ExtendedColorFamily(
    Color.Unspecified, Color.Unspecified, Color.Unspecified, Color.Unspecified
)

val LocalExtendedColors = compositionLocalOf { ExtendedColorScheme(unspecified_scheme) }
...
fun EatFairTheme(
    ...
    // 2. Get the current View and Activity Window
//    val view = LocalView.current
//    if (!view.isInEditMode) {
//        SideEffect {
//            val window = (view.context as Activity).window
//
//            // 3. Set the status bar color (e.g., to the Primary color)
//            window.statusBarColor = colorScheme.primary.toArgb()
//
//            // Optional: Set the navigation bar color (e.g., to the Background color)
//            window.navigationBarColor = colorScheme.background.toArgb()
//
//            // 4. Control status bar icon contrast (light/dark icons)
//            // This is crucial for readability if your status bar color is light/dark
...
fun primaryVerticalGradient(): Brush {
    ...
    // Return the vertical gradient brush
